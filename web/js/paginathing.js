...
(function ($, window, document) {
    ...
    Paginator.prototype = {
        ...
        handle: function (appendTo) {
            var _self = this;

            _self.movePaginator(appendTo);
        ...
        show: function (page) {
            ...
            if (paginatorInstalled) {
                scrollToTopResult();
            }
        },

        /**
         * Custom function that remove the nav from the table and put it
         * at its bottom.
         */
        movePaginator: function () {
            ...
            if ($(_self.container) && appended) {
                $(_self.container).detach();
                appended = false;
            }

            if ($(_self.appendTo) && !appended) {
                $(_self.container).appendTo($(_self.appendTo));
                appended = true;
            }
